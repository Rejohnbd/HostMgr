                ...
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="form-row checked-company-form">
                        ...
                        <div class="form-group col-md-12 required">
                            ...
                            <input type="number" name="customer_mobile" class="form-control @error('customer_mobile') is-invalid @enderror" id="customerMobileNumber" placeholder="Customer Mobile Number" value="{{ old('customer_mobile')  }}">
