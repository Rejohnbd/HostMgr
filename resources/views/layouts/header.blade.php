...
<head>
  ...
  @endif
  @if(Request::is('customers/create') || Request::is('services/create') || Request::is('domain-reseller/*/renew') || Request::is('hosting-reseller/*/renew') || Request::is('invoices/*/create'))
